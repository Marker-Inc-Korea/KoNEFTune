...
class LlamaModel(LlamaPreTrainedModel):
    ...
    def forward(
        ...
        if inputs_embeds is None:
            ...
            # NEFTuning (noisy_embedding)
            if train_opt and NEFT_bool: # If training and applying NEFT_bool
              dims = torch.tensor(inputs_embeds.size(1) * inputs_embeds.size(2))
              mag_norm = noisy_alpha/torch.sqrt(dims) # noisy_alpha/torch.sqrt(dims)
