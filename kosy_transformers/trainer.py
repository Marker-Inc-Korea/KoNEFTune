...
class Trainer:
    ...
    def __init__(
        ...
        # 10/23: noise_alpha adding
        if noise_alpha is None:
            self.NEFTune = False
            self.alpha = None
            print("#### Not applying noise embedding ####")
        else:
            self.NEFTune = True
            self.alpha = noise_alpha
            print("#### Applying noise embedding ####")
    ...
    def _prepare_inputs(self, inputs: Dict[str, Union[torch.Tensor, Any]]) -> Dict[str, Union[torch.Tensor, Any]]:
        ...
        inputs['alpha'] = self.alpha
        inputs['NEFTune'] = self.NEFTune
        if len(inputs) == 0:
            raise ValueError(
